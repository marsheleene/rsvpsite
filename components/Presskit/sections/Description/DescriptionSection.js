    ...
    return (
        <Item title="Description">
            <div className="md:flex flex-col items-center">
                <p className="md:max-w-xl p-8 shadow-xl border-2 rounded-2xl border-borderColor bg-white">La famille Lagrange des Bas-Moulins a besoin de vous pour
                    organiser les plans de table de leurs mariages ! Les marié·e·s auront toujours des instructions précises que vous devrez suivre. Pour
